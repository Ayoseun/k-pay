...
export function initializeEventListeners(paymentData) {
  ...
  async function cardSubmit(amount, expiryDateInput, cvcInput,
  ...
  async function tokenizeCardSubmit(amount, spinner,
    summaryConfirmBtn, summaryBackBtn, cardDetails, summaryContainer,
  ...
  const connectWallet = async (amount, targetChain, exchangeRateSpan, cryptoAmountSpan) => {
